...
(function ($) {
    ...
    var mainApp = {
        ...
        main_fun:function() {
            ...
            $(function () {
                $.vegas('slideshow', {
                    backgrounds: [
                      ...
                      { src: 'assets/img/4.jpg', fade: 1000, delay: 9000 }, //THESE IMAGES ARE FOR DEMO PURPOSE ONLY YOU, CAN NOT USE THEM WITHOUT AUTHORS PERMISSION
            ...
            $(function () {
                var $header = $("#headLine");
                var header = ["We'll Be . .", "Right Back"]; // CHANGE TEXT HERE TO YOUR TEXT , YOU CAN USE MANY WORDS SEPRATED BY , 
